...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.edited_at'
        db.add_column('forum_post', 'edited_at', orm['forum.post:edited_at'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Post.edited_at'
        db.delete_column('forum_post', 'edited_at')
